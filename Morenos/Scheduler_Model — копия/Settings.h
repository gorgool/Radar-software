...
namespace settings
{
  ...
  static const double tracking_query_threashold = 1.0;

  // Порог выполнения заявки на дообнаружение
  static const double confirm_query_threashold = 0.0;
  ...
  static const std::uint32_t pulse_train_planning_depth = 15;
}
